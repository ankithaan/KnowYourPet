...
<?php
 ...
 $query="SELECT * FROM breeds1 b , petdata1 p where p.breed=b.breed";
...
?>
	 ...
	 <div class="container">
        <div class="row">
            <div class="col-lg-12">
			<a href="allbreeds.php" ><button type="button" class="btn btn-light btn-lg" ><i class="fa fa-mobile" aria-hidden="true"></i>
                        View Breed Details</button>
