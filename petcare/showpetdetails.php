...
<?php
 ...
 $query="SELECT * FROM petdata1 p , users u where p.username=u.username";
...
<td><a href="editpetdetails.php?&id=<?php echo $row[0];?>">EDIT</a></td>
<td><a href="deletepetdetails.php?&id=<?php echo $row[0];?>">DELETE</a></td>
<?php
