...
<div class="content">
  ...
  <div class="container">
        <div class="row">
            <div class="col-lg-12">
			<a href="petdetails.php" ><button type="button" class="btn btn-light btn-lg" ><i class="fa fa-mobile" aria-hidden="true"></i>
                        Enter Pet Details!</button>
						<a href="showpetdetails.php" ><button type="button" class="btn btn-light btn-lg" ><i class="fa fa-mobile" aria-hidden="true"></i>
                        Show Pet Details!</button>
                </div>
            </div>
        </div>
		<!-- Slideshow container -->
<div class="slideshow-container">
  ...
  <div class="mySlides fade">
    ...
    <img src="h1.jfif" style="width:100%">
